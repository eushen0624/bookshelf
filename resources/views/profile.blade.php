        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body w-full">
                    ...
                    <form action="/upateprofile/{{$user->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')


                        <div class="w-3/3 flex flex-column items-center py-4" >
                            <img src="/uploads/avatars/{{$user->avatar}}" style="width:200px; height:200px; border-radius: 50%;" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="w-3/3 flex flex-column items-center">
